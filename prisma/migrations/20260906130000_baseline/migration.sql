-- Baseline schema for fresh PostgreSQL databases.
-- This migration intentionally represents the schema immediately before
-- 20260906132000_add_owner_agency, so fresh databases can replay the full history.
...
ADD CONSTRAINT "Applicant_agentId_fkey"
FOREIGN KEY ("agentId") REFERENCES "User"("id")
ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "Followup"
ADD CONSTRAINT "Followup_assigneeId_fkey"
FOREIGN KEY ("assigneeId") REFERENCES "User"("id")
ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "Followup"
ADD CONSTRAINT "Followup_ownerId_fkey"
FOREIGN KEY ("ownerId") REFERENCES "Owner"("id")
ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "Followup"
ADD CONSTRAINT "Followup_applicantId_fkey"
FOREIGN KEY ("applicantId") REFERENCES "Applicant"("id")
ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "Followup"
ADD CONSTRAINT "Followup_propertyId_fkey"
FOREIGN KEY ("propertyId") REFERENCES "Property"("id")
ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "Contract"
ADD CONSTRAINT "Contract_propertyId_fkey"
FOREIGN KEY ("propertyId") REFERENCES "Property"("id")
ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "Contract"
ADD CONSTRAINT "Contract_applicantId_fkey"
FOREIGN KEY ("applicantId") REFERENCES "Applicant"("id")
ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "Contract"
ADD CONSTRAINT "Contract_agentId_fkey"
FOREIGN KEY ("agentId") REFERENCES "User"("id")
ON DELETE RESTRICT ON UPDATE CASCADE;
